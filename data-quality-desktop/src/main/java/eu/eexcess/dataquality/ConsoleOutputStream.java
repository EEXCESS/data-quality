 ...
 * based on https://github.com/zaplatynski/second-hand-log
 */
public class ConsoleOutputStream extends ByteArrayOutputStream {
   ...
   */
  public ConsoleOutputStream(final MessageConsole messageConsole, 
  ...
  private void clearBuffer() {
    ...
    try {
      final SimpleAttributeSet textStyle = new SimpleAttributeSet();
      if (append) {
